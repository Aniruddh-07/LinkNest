...
import { LinkNestIcon, GithubIcon } from "../icons";
...
export function SignupForm() {
  const { signup, signInWithGoogle, signInWithGitHub, isFirebaseConfigured, loading: authLoading } = useAuth();
  ...
  const handleSocialLogin = async (provider: 'google' | 'github') => {
      ...
      try {
          ...
          setError(err.message || `An error occurred during sign up with ${provider}.`);
      } finally {
